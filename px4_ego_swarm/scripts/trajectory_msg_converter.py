...
class MessageConverter:
    def __init__(self):
        ...
        setpoint_position_pub_topic = rospy.get_param('~setpoint_position_pub_topic', '/drone0/mavros/setpoint_position/local')
        setpoint_raw_pub_topic = rospy.get_param('~setpoint_raw_pub_topic', '/drone0/mavros/setpoint_raw/local')
        ...
        rospy.Subscriber(ego_planner_traj_topic, PositionCommand, self.fastPlannerTrajCallback, tcp_nodelay=True)
